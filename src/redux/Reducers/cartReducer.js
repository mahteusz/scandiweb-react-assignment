...
export const cartReducer = (state = initialState,  { type, payload }) => {
    switch(type){
        case ActionTypes.ADD_PRODUCT_TO_CART:
            return {...state, cartProducts: stackProductsWithSameAttributes(payload, state.cartProducts)}
        case ActionTypes.REMOVE_PRODUCT_FROM_CART:
            return {...state, cartProducts: removeProduct(payload, state.cartProducts)}
